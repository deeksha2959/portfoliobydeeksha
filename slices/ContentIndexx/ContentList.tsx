...
type ContentListProps={
  ...
  contentType: Content.ContentIndexxSlice["primary"]["content_type"];
  fallbackItemImage: Content.ContentIndexxSlice["primary"]["fallback_item_image"];
  viewMoretext:Content.ContentIndexxSlice["primary"]["view_more_text"];
