...
type HomepageDocumentDataSlicesSlice = HeroineSlice;
...
/**
 * Primary content in *ContentIndexx → Primary*
 */
export interface ContentIndexxSliceDefaultPrimary {
  /**
   * Heading field in *ContentIndexx → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_indexx.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;

  /**
   * Content Type field in *ContentIndexx → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: content_indexx.primary.content_type
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  content_type: prismic.SelectField<"Blog" | "Project">;

  /**
   * Description  field in *ContentIndexx → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_indexx.primary.description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;

  /**
   * View More Text field in *ContentIndexx → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_indexx.primary.view_more_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  view_more_text: prismic.KeyTextField;

  /**
   * Fallback item image field in *ContentIndexx → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_indexx.primary.fallback_item_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Default variation for ContentIndexx Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ContentIndexxSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ContentIndexxSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ContentIndexx*
 */
type ContentIndexxSliceVariation = ContentIndexxSliceDefault;

/**
 * ContentIndexx Shared Slice
 *
 * - **API ID**: `content_indexx`
 * - **Description**: ContentIndexx
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ContentIndexxSlice = prismic.SharedSlice<
  "content_indexx",
  ContentIndexxSliceVariation
>;

/**
 * Primary content in *Experiance → Primary*
 */
export interface ExperianceSliceDefaultPrimary {
  /**
   * Heading field in *Experiance → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
...
/**
 * Primary content in *Experiance → Items*
 */
export interface ExperianceSliceDefaultItem {
  /**
   * Title field in *Experiance → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Time Period field in *Experiance → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Institution field in *Experiance → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Description field in *Experiance → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
...
/**
 * Default variation for Experiance Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Slice variation for *Experiance*
 */
type ExperianceSliceVariation = ExperianceSliceDefault;

/**
 * Experiance Shared Slice
 *
 * - **API ID**: `experiance`
...
/**
 * Primary content in *Heroine → Primary*
 */
export interface HeroineSliceDefaultPrimary {
  /**
   * first name field in *Heroine → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: heroine.primary.first_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  first_name: prismic.KeyTextField;

  /**
   * last name field in *Heroine → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: heroine.primary.last_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  last_name: prismic.KeyTextField;

  /**
   * tag line field in *Heroine → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: heroine.primary.tag_line
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Default variation for Heroine Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroineSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<HeroineSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *Heroine*
 */
type HeroineSliceVariation = HeroineSliceDefault;

/**
 * Heroine Shared Slice
 *
 * - **API ID**: `heroine`
 * - **Description**: Heroine
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroineSlice = prismic.SharedSlice<
  "heroine",
  HeroineSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ContentIndexxSlice,
      ContentIndexxSliceDefaultPrimary,
      ContentIndexxSliceVariation,
      ContentIndexxSliceDefault,
      ExperianceSlice,
